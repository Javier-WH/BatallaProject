        ...
        <div id="windowContainer">
            <div id="MainContainer1">
                ...
                <div id="Contenedor-Buscar-Alumno" class="contenedor">
                    ...
                    <div>
                        <button id="btn-Limpiar" class=""> <svg class="iconoBoton2" viewBox="0 0 20 20" id="btn-Limpiar2">
                                <script>
                                    document.write(icono_flechaIzquierda)
                                </script>
                            </svg>
                        </button>
                    </div>
                    ...
                    <table id="table1">
                        ...
                        <tr>
                            ...
                            <td class="Columna-Botones" class="td1">
                                <button id="btn-Guardar"><svg class="iconoBoton" viewBox="0 0 20 20">
                                        <script>
                                            document.write(icono_guardar)
                                        </script>
                                    </svg></button>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td id="contenedorBotones" class="td1">
                                <button id="btn-Anterior"><svg class="iconoBoton" viewBox="0 0 20 20" id="BA">
                                        <script>
                                            document.write(icono_anterior)
                                        </script>
                                    </svg></button>
                                <button id="btn-Siguiente"><svg class="iconoBoton" viewBox="0 0 20 20" id="BS">
                                        <script>
                                            document.write(icono_siguiente)
                                        </script>
                                    </svg></button>
                            </td>
                        </tr>
